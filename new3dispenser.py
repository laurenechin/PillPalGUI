...
class Ready2(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        button1 = ctk.CTkButton(self,
                                ...
                                border_color='red',
                                hover_color='red',
                                command=lambda: self.controller.show_frame(Dispense3))
...
class Dispense3(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        testbutton = ctk.CTkButton(self,
                                  text="Test",
                                  command=lambda: self.controller.show_frame(Daysleft4))
...
class Daysleft4(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        label3 = ctk.CTkLabel(self,
                              width=800,
                              height=480,
                              text="You have {days} day(s) \n of {evening_pills[index].Ename} left",  # days = variable
                              text_color='black',
                              font=('Sans-Serif', 35, 'bold'),
                              fg_color='#ffb9d5')
        label3.pack()
        ...
        testbutton1 = ctk.CTkButton(self,
                                   text="Back to Streak 1",
                                   command=lambda: self.controller.show_frame(Streak1))
